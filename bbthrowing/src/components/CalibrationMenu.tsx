...
export default function CalibrationMenu({
  ...
  const handleArmLengthChange = (len: number) => {
  ...
  return (
    <div id="calibration-menu-container" className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-2xl">
      <div className="flex items-center gap-3 border-b border-slate-800 pb-4 mb-5">
        ...
        <h2 className="font-display text-lg font-semibold text-slate-100 tracking-tight animate-pulse">
          Arm & Space Calibration
        </h2>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div>
          <label className="block text-xs font-medium text-slate-400 uppercase tracking-wider mb-2">
            Fielder Height (Reference Object 1)
          </label>
          ...
          <p className="text-[11px] text-slate-500 mt-1">
            Calibrates vertical coordinate scaling and release height estimations.
          </p>
        </div>
        ...
        <div>
          <label className="block text-xs font-medium text-slate-400 uppercase tracking-wider mb-2">
            Arm Reach Length (Reference Object 2)
          </label>
          <div className="flex items-center bg-slate-950 border border-slate-800 rounded-lg px-3 focus-within:border-emerald-500 transition-colors">
            <input
              ...
              onChange={(e) => handleArmLengthChange(parseFloat(e.target.value) || 30)}
              className="w-full bg-transparent border-none outline-none py-2 text-slate-100 text-sm font-mono text-right pr-2"
            />
            <span className="text-xs font-semibold text-slate-500">INCHES</span>
          </div>
          <p className="text-[11px] text-slate-500 mt-1">
            Shoulder-to-fingertip distance. Used to convert pixel movement to physical velocity (MPH).
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-[11px] text-slate-500 mt-1">
            High-speed capture frequency for precise release-time tracking.
          </p>
        </div>
        ...
        <div className="border-t border-slate-800 pt-4 mt-2">
          ...
          <div className="bg-slate-950/60 rounded-lg p-3 mt-3 border border-slate-800/60">
            ...
            <p className="text-[10px] text-slate-500 leading-relaxed">
              When calibrating, click and drag the ruler endpoints over the throwing arm length (shoulder to fingertips) in the video frame to lock spatial parameters.
            </p>
          </div>
        </div>
      </div>
